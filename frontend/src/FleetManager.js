            ...
            <div className="max-w-5xl mx-auto bg-white p-6 rounded-lg shadow-md">
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <input className="border p-2 rounded" name="vin" placeholder="VIN" value={form.vin}
                           onChange={handleChange}/>
                    <input className="border p-2 rounded col-span-2" name="license_plate" placeholder="License Plate"
                        ...
                        <tr key={v.id} className="text-center">
                            ...
                            <td className="border px-4 py-2 space-x-2">
                                <button onClick={() => handleEdit(v)}
                                        className="bg-yellow-400 hover:bg-yellow-500 text-white px-3 py-1 rounded">Edit
                                </button>
                                <button onClick={() => handleDelete(v.id)}
                                        className="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded">Delete
                                </button>
                            </td>
                        </tr>
                    ))}
